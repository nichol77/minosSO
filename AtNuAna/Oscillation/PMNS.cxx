////////////////////////////////////////////////////////////////////////
// $Id: PMNS.cxx,v 1.4 2011/03/25 21:49:03 blake Exp $
//
...
void PMNS::SetDeltaMsqrs(double dm21, double dm32) 
{
  ...
  for (register int i=0; i<3; ++i) {
    for (register int j=0; j<3; ++j) {
      ...
      // all the indicies in all the equations, flip the signs here.
		    ...
		    const double  dMsqr[][3]) 
{
  ...
  // There are three matricies which can apper inside the product on
		    ...
		    double gamma)
{
  ...
  // program. Otherwise, set it to its rail value.

  //  The code had a small bug:
