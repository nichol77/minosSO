...
runtag=runii
outtag=runii_pred_main
outcount=0;

DIR=/unix/minos1/rjn/DSTs/2010/R2.2/MC/D07_dogwood3/far/r2/micro2010/
...
do
  echo "${fileArray[$i]} ${fileArray[$i+1]} ${fileArray[$i+2]} ${fileArray[$i+3]}"
    outfile=/unix/minos1/rjn/ccPlusNc/farPreds/run2/main${outcount}.root
    echo $outfile;
