...
void runNuDstLooperRunVIPred()
{
  gSystem->CompileMacro("src/OscCalc.C","k");
   gSystem->CompileMacro("src/NuDstLooper.C","k");
   TChain *theChain = new TChain("s");
   theChain->Add("/minos/data/analysis/NuMuBar/DSTs/2010/R2.2/MC/D07_dogwood3/far/r3/micro2010/NuDSTMicro*.root"); //Using old r3 MC DSTs for now
   ...
   fred.MakePredicitions("/minos/data/users/rjn/farPred/runvi_pred_main.root",ndRatNQ,ndRatPQ,ndRatNC,ndRatNCTrack,"runvi_pred_main"); 
}
