...
void runNuDstLooperRunIITauPred()
{
  gSystem->CompileMacro("src/OscCalc.C","k");
   gSystem->CompileMacro("src/NuDstLooper.C","k");
   TChain *theChain = new TChain("s");
   theChain->Add("/minos/data/analysis/NuMuBar/DSTs/2010/R2.2/MC/D07_dogwood3/tau/r2/micro2010/NuDSTMicro*.root");
   ...
   fred.MakePredicitions("/minos/data/users/rjn/farPred/runii_pred_tau.root",ndRatNQ,ndRatPQ,ndRatNC,ndRatNCTrack,"runii_pred_tau"); 
}
