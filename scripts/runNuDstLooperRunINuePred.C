...
void runNuDstLooperRunINuePred()
{
  gSystem->CompileMacro("src/OscCalc.C","k");
   gSystem->CompileMacro("src/NuDstLooper.C","k");
   TChain *theChain = new TChain("s");
   theChain->Add("/minos/data/analysis/NuMuBar/DSTs/2010/R2.2/MC/D07_dogwood3/nue/r1/NuDSTMicro*.root");
   ...
   fred.MakePredicitions("/minos/data/users/rjn/farPred/runi_pred_nue.root",ndRatNQ,ndRatPQ,ndRatNC,ndRatNCTrack,"runi_pred_nue"); 
