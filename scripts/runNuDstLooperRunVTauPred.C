...
void runNuDstLooperRunVTauPred()
{
  gSystem->CompileMacro("src/OscCalc.C","k");
   ...
   fred.MakePredicitions("/minos/data/users/rjn/farPred/runv_pred_tau.root",ndRatNQ,ndRatPQ,ndRatNC,ndRatNCTrack,"runv_pred_tau"); 
