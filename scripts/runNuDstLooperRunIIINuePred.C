...
void runNuDstLooperRunIIINuePred()
{
  gSystem->CompileMacro("src/OscCalc.C","k");
   gSystem->CompileMacro("src/NuDstLooper.C","k");
   TChain *theChain = new TChain("s");
   theChain->Add("/minos/data/analysis/NuMuBar/DSTs/2010/R2.2/MC/D07_dogwood3/nue/r3/NuDSTMicro*.root");
   ...
   fred.MakePredicitions("/minos/data/users/rjn/farPred/runiii_pred_nue.root",ndRatNQ,ndRatPQ,ndRatNC,ndRatNCTrack,"runiii_pred_nue"); 
